    ...
    <div className="min-h-screen bg-[#f5f5f7] text-[#17171a] lg:grid lg:grid-cols-[235px_1fr] lg:grid-rows-[76px_1fr]">
      <header className="sticky top-0 z-20 flex h-[76px] items-center justify-between border-b border-[#e5e5e9] bg-white px-4 lg:col-span-2 lg:px-7">
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div
            className={`grid h-11 w-11 shrink-0 place-items-center rounded-xl text-xl font-black text-white ${markClassName}`}
          >
            {brandMark}
          </div>
          <div className="min-w-0">
            <b className="block truncate text-[19px] font-black tracking-[0.12em]">{brandTitle}</b>
            <small className="mt-0.5 block truncate text-[10px] font-extrabold tracking-[0.13em] text-[#aaa]">
              {brandSubtitle}
            </small>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div className="flex items-center gap-2.5 border-l border-[#e5e5e9] pl-2.5 sm:pl-3">
            ...
            <div className="hidden leading-tight sm:block">
              ...
              <span className="text-[11px] text-[#8d8d96]">{roleLabel}</span>
            </div>
